...
public class TestTowerOfHanoi 
{
	...
	{
		ArrayList<String> result2 = (ArrayList<String>) new TowerOfHanoi().towerOfHanoi("A", "B", "C", 2);
		assertEquals(expectedListForValue2, result2 );
	}
	@Test
	public void testTowerForValue1() 
	{
		ArrayList<String> result3 = (ArrayList<String>) new TowerOfHanoi().towerOfHanoi("A", "B", "C", 1);
